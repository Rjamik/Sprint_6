...
class TestOrderPage:
    ...
    def test_order_by_header_order_button(self, driver, agree_with_cookie):
        ...
        base_page.wait_until_element_visibility(5, OrderPageLocators.NEXT_BUTTON)
        ...
        base_page.wait_until_element_visibility(5, OrderPageLocators.SELECT_METRO)
        ...
        base_page.wait_until_element_visibility(5, OrderPageLocators.CALENDAR)
        order_page.choose_date_today()
        order_page.focus_on_field_rental_period()
        base_page.wait_until_element_visibility(5, OrderPageLocators.RENTAL_PERIOD_DROPDOWN_MENU)
        order_page.choose_min_rental_period()
        order_page.choose_black_color()
        order_page.fill_comment(user_1.comment)
        order_page.submit_order()

        assert base_page.find_the_element(5, OrderPageLocators.ORDER_SUCCESS_TITLE).is_displayed(), \
