...
class TestHeaderPage:
    ...
    def test_redirect_by_scooter_logo(self, driver, agree_with_cookie):
        ...
        assert base_page.find_the_element(5, MainPageLocators.MAIN_PAGE_ORDER_BUTTON).is_displayed(), \
    ...
    def test_redirect_by_yandex_logo(self, driver, agree_with_cookie):
        ...
        assert base_page.find_the_element(10, YandexSiteLocators.SEARCH_SUBMIT_BUTTON).is_displayed(), \
